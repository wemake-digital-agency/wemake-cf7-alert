...
if (!class_exists('Wemake_CF7_Alert_GitHub_Updater')) {

    class Wemake_CF7_Alert_GitHub_Updater
    {
        private $plugin_file;
        private $plugin_slug;
        private $github_repo = 'wemake-digital-agency/wemake-cf7-alert';
        private $github_api_url = 'https://api.github.com/repos/wemake-digital-agency/wemake-cf7-alert/releases/latest';
...
//            error_log(print_r($release, true));
    ...
    add_action('admin_init', function () {
        new Wemake_CF7_Alert_GitHub_Updater(wmcfa_get_plugin_row_path());
    });
}
